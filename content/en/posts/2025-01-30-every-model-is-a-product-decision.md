...
I lived this inside our own team more than once. Our product manager had been asked to grow revenue this quarter. Our finance partner had been asked to protect retention through the end of the year. We had the same data, the same recommendations on the table, and a quietly different sense of what success even meant. Both readings were honest. Both were doing what someone in the organisation had asked for. Nobody had asked us to reconcile the two before we started building.
...
Whenever we treated explainability as something to bolt on after the model landed, we lost the trust battle. By the time the call from support came in, the answer we could give was either too vague to be useful or too technical to be repeated. The next time a price looked odd, the question stopped going to us. It started going around us.
...
What kept our model honest, when it stayed honest, was a single sentence. What it was optimising for. What it was deprioritising in order to do that. And who in the organisation had said yes to the trade. When that sentence didn't exist yet, the right move was usually to stop building and go find it.
