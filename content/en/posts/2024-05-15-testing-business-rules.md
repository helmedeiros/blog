...
**The fixture is named after the rule set version.** `2024-q1.yaml`. When the rules change next quarter, a new fixture is added; the old test still passes against the old fixture; the team can see at a glance which test pins which agreement.
